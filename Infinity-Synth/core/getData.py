...
class GetData:
    ...
    def __init__(
        ...
        self.stamp_iter = itertools.cycle(self.stamp)
        self.logo_iter = itertools.cycle(self.logo)
        self.signature_iter = itertools.cycle(self.signature)
        self.header_iter = itertools.cycle(self.header)
        self.footer_iter = itertools.cycle(self.footer)
